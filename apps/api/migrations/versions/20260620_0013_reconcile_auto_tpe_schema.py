"""Reconcile automatic TPE schema after legacy 0012 stamps.
...
def upgrade() -> None:
    _drop_table_if_present("tpe_trials")
    _drop_table_if_present("tpe_calibration_jobs")
...
def downgrade() -> None:
    raise RuntimeError("Downgrade from automatic TPE schema reconciliation is intentionally unsupported.")
