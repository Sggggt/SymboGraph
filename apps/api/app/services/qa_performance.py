...
Stage = Literal[
    ...
    "path_features", "feature_preparation", "lexical_repair", "evidence_sufficiency", "packing", "context_package", "source_admission",
    "evidence_directory", "evidence_decision", "evidence_read", "evidence_freeze", "generation", "source_binding",
