...
def model_settings_payload() -> dict:
    ...
    return {
        ...
        "agent_fine_entry_budget": read_env_int("AGENT_FINE_ENTRY_BUDGET", settings.agent_fine_entry_budget),
        ...
        "agent_ambiguous_edge_distance_low": read_env_float("AGENT_AMBIGUOUS_EDGE_DISTANCE_LOW", settings.agent_ambiguous_edge_distance_low),
        "agent_ambiguous_edge_distance_high": read_env_float("AGENT_AMBIGUOUS_EDGE_DISTANCE_HIGH", settings.agent_ambiguous_edge_distance_high),
