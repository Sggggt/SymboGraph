...
def model_settings_payload() -> dict:
    ...
    return {
        ...
        "agent_coarse_activation_budget": read_env_int("AGENT_COARSE_ACTIVATION_BUDGET", settings.agent_coarse_activation_budget),
        "agent_coarse_jump_budget": read_env_int("AGENT_COARSE_JUMP_BUDGET", settings.agent_coarse_jump_budget),
        "agent_mid_activation_budget": read_env_int("AGENT_MID_ACTIVATION_BUDGET", settings.agent_mid_activation_budget),
        "agent_mid_expansion_radius_cap": read_env_int("AGENT_MID_EXPANSION_RADIUS_CAP", settings.agent_mid_expansion_radius_cap),
        "agent_fine_cluster_budget": read_env_int("AGENT_FINE_CLUSTER_BUDGET", settings.agent_fine_cluster_budget),
