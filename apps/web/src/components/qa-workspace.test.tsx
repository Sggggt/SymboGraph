...
import type { AnswerModelAudit, Citation, ConversationStatePayload } from "@course-kg/shared";
import { AGENT_PARAMETER_HELP, AgentParameterName, answerAuditFromTrace, answerUsageLabel, ConversationStatePanel, legacyQaPayloadStorageKeys, MessageBubble, normalizeMessages, preserveTurnTraces, productQaErrorMessage } from "./qa-workspace";
...
describe("AgentParameterName", () => {
  ...
  it("renders parameter help with a 1000ms hover delay", () => {
    ...
    expect(tooltip.textContent).toContain("一次回答能够接收的原文证据上限");
